    ...
    <article className="min-h-screen bg-[#f8f5ff] px-5 py-10 text-[#17112f] md:px-12 md:py-16">
      <div className="mx-auto max-w-4xl rounded-[28px] border border-[#e7e0f8] bg-white px-6 py-8 shadow-[0_24px_80px_rgba(76,32,184,0.12)] md:px-12 md:py-12">
        ...
        <p className="mt-6 leading-8 text-[#3d3654]">
          IT:PLACE는 이용자의 개인정보를 중요하게 생각하며, 개인정보 보호 관련 법령을 준수하기 위해
          다음과 같이 개인정보 처리방침을 공개합니다. 본 방침은 IT:PLACE 웹 및 모바일 앱 서비스에
          적용됩니다.
        </p>
        ...
        <section className="mt-10 rounded-3xl bg-[#f5f3ff] p-6">
          <h2 className="text-xl font-black tracking-[-0.02em] text-[#27184f]">10. 문의</h2>
          ...
          <dl className="mt-5 grid gap-3 text-sm md:grid-cols-[120px_1fr]">
            <dt className="font-bold text-[#6b6478]">서비스명</dt>
            <dd className="font-bold text-[#17112f]">IT:PLACE</dd>
            <dt className="font-bold text-[#6b6478]">문의 이메일</dt>
            <dd>
              <a
                className="font-bold text-[#7638fa] underline"
